...
###########################################################
print_db_usage () {
  echo "node2 for PUBSUB test has been setup"
  echo "  Host: $GUEST_IP  [ node2.qhacemos ]"
  echo "  Guest IP: $GUEST_IP"
  echo "    added:   \"node2.qhacemos   $GUEST_IP\"   to /etc/hosts"
  echo ""
...
echo "$GUEST_IP   node2.qhacemos" >> /etc/hosts
...
echo "Successfully created NODE2 virtual machine to test PubSub"
echo ""
print_db_usage
