...
error.codes = require('lib/error/codes');
...
/* TODO: remove this error type as it is not being used nor likely to in this project*/
/*
error.UnsupportedMediaError = class UnsupportedMediaError extends error.ErrorBase {
	constructor ( message, origval, code ) {
		super ( message, code || error.codes.UNSUPPORTED_MEDIA, 415 );
...
/* TODO: remove this error type as it is not being used nor likely to in this project*/
/*
error.UnsupportedCharSetError = class UnsupportedCharSetError extends error.ErrorBase {
	constructor ( message, origval, code ) {
		super ( message, code || error.codes.UNSUPPORTED_CHARSET, 415 );
		this.origValue = origval;
	}
};
*/
